      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
            ...
            <a href="#projects" className="px-8 py-4 rounded-lg font-bold text-white border border-gray-600 hover:border-cyan-400 hover:text-cyan-400 transition-all duration-300 glass-panel flex items-center justify-center">
              Explore Our Work
            </a>
          </div>
        </div>
            ...
            <div>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  {/* Portfolio */}
                  <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:text-green-400 hover:bg-gray-700 hover:shadow-[0_0_10px_rgba(74,222,128,0.4)] transition-all" title="Portfolio">
